...
app.get('/games/:id/ads', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return response.json(ads.map(ad => {
        var _a;
        return Object.assign(Object.assign({}, ad), { weekDays: (_a = ad.weekDays) === null || _a === void 0 ? void 0 : _a.split(',') });
    }));
}));
app.get('/games/:id/discord', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const adId = request.params.id;
